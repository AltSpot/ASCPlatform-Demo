...
const COMPANIES: RadarCompany[] = [
  ...
  },
  {
    ...
    marketAverageCents: 410,
    marketAverageAsOf: 'Seed reference',
    lastRoundLabel: 'Seed',
    lastRoundValuation: 32_000_000,
    targetLowCents: 360,
    targetHighCents: 430,
    minIndication: 10_000,
  ...
  },
  {
    ...
    marketAverageCents: 180,
    marketAverageAsOf: 'Pre-seed reference',
    lastRoundLabel: 'Pre-seed',
    lastRoundValuation: 14_000_000,
    targetLowCents: 150,
    targetHighCents: 190,
    minIndication: 10_000,
