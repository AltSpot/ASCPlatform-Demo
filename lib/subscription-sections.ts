 ...
 *
 * Every word below is derived from the ASC Simphonic II subscription
...
export const SUBSCRIPTION_SECTIONS: readonly SubscriptionSection[] = [
  {
    ...
    points: [
      ...
      {
        text: 'You had the chance to put questions to the Manager about the offering, the Company and Simphonic, and you got answers.',
      },
      {
      ...
      {
        text: 'Beyond what the offering documents say, AltSpot makes no representation about Simphonic, its business or its prospects, and has not independently verified the Simphonic information in them.',
      },
      {
      ...
      {
        text: 'If the Company does not end up buying the Simphonic securities, uninvested funds come back to you without interest.',
      },
    ],
  },
...

  {
    ...
    points: [
      {
        text: 'This is speculative. The Company holds one asset: Series Seed Preferred Stock of Simphonic, Inc., together with warrants over its common stock. There is no diversification inside the Company and you can lose the entire amount.',
      },
      {
    ...
    points: [
      {
        ...
        text: 'Signing admits you as a Class B Member of ASC Simphonic II, LLC and binds you to the operating agreement in full, including the representations in its Article 10, as if you had signed it on its original date.',
      },
      {
