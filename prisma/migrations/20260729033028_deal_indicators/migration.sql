...
INSERT INTO "new_deals" ("allocationRemaining", "allocationTotal", "altspotCommitted", "art", "blurb", "committedNote", "createdAt", "deckJson", "docsJson", "entity", "feesJson", "headline", "id", "kind", "logoUrl", "mediaJson", "metricsJson", "minInvestment", "name", "outcomesJson", "preferredTermsJson", "pricePerShare", "risks", "sector", "sortOrder", "spotbotJson", "stage", "status", "summary", "tag", "targetClose", "termsJson", "thesisJson", "updatedAt", "whatWeLikeJson") SELECT "allocationRemaining", "allocationTotal", "altspotCommitted", "art", "blurb", "committedNote", "createdAt", "deckJson", "docsJson", "entity", "feesJson", "headline", "id", "kind", "logoUrl", "mediaJson", "metricsJson", "minInvestment", "name", "outcomesJson", "preferredTermsJson", "pricePerShare", "risks", "sector", "sortOrder", "spotbotJson", "stage", "status", "summary", "tag", "targetClose", "termsJson", "thesisJson", "updatedAt", "whatWeLikeJson" FROM "deals";
DROP TABLE "deals";
