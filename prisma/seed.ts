...
const DEALS: SeedDeal[] = [
  ...
  // ------------------------------------------------------------------
  //  CLOSED, held by the demo account (2026-09-19). Every position the
  //  seeded member holds is in an SPV that has closed, so the book never
  //  contradicts the shelf: nobody holds a marked position in a deal that
  //  is still raising. Invented companies.
  // ------------------------------------------------------------------
  {
    id: 'solenne',
    name: 'Solenne Health',
    entity: 'ASC Solenne I, LLC',
    tag: 'AltSpot-led · Series B',
    kind: 'led',
    sector: 'Remote Cardiac Care · Healthcare',
    stage: 'Series B Preferred',
    assetClass: 'venture',
    industry: 'healthcare',
    art: 'linear-gradient(135deg,#1D0B15 0%,#4A1F38 55%,#F0A6CA 118%)',
    headline: 'Cardiac monitoring that goes home with the patient.',
    blurb:
      'Remote cardiac monitoring sold to cardiology groups on outcome contracts. Closed in February 2026.',
    thesis: [],
    indicators: {},
    rounds: [],
    metrics: [],
    terms: [
      { k: 'Security', v: 'Series B Preferred Stock' },
      { k: 'Closed', v: 'Feb 20, 2026' },
    ],
    preferredTerms: [],
    whatWeLike: [],
    outcomes: {},
    risks:
      'Private investments are illiquid and can lose all of their value. This position is held to an exit whose timing is not known.',
    minInvestment: 25000,
    allocationTotal: 3000000,
    allocationRemaining: 0,
    targetClose: 'Feb 20, 2026',
    altspotCommitted: 0,
    committedNote: '',
    sortOrder: 88,
    status: 'closed',
  ...
  {
    id: 'tidewater',
    name: 'Tidewater Industrial',
    entity: 'ASC Tidewater I, LLC',
    tag: 'AltSpot-led · Growth equity',
    kind: 'led',
    sector: 'Marine Services · Industrials',
    stage: 'Growth equity',
    assetClass: 'growth',
    industry: 'industrials',
    art: 'linear-gradient(135deg,#07161E 0%,#123A4E 55%,#5BC0EB 118%)',
    headline: 'The yards that keep the Gulf fleet working.',
    blurb:
      'A profitable marine services group consolidating regional repair yards. Closed in November 2025.',
    thesis: [],
    indicators: {},
    rounds: [],
    metrics: [],
    terms: [
      { k: 'Security', v: 'Minority common equity' },
      { k: 'Closed', v: 'Nov 21, 2025' },
    ],
    preferredTerms: [],
    whatWeLike: [],
    outcomes: {},
