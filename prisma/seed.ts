/**
 * Marketplace seed — the curated shelf.
 *
 * Fee model per deal: 5% platform fee · up to 2% admin reserve (itemized;
 * unused remainder returned to investors at close) · 10% carry, 20% when
 * AltSpot leads. All companies are fictional.
 *
...
interface SeedDeal {
  ...
  sortOrder: number;
  thesis: string[];
  fees: { platform: number; adminMax: number; carry: number; carryNote: string };
...
const DEALS: SeedDeal[] = [
  {
    ...
    media: {
      ...
      caption:
        'Indexed NRR by quarter, Q3 2024 – Q2 2026 (company data, AltSpot memo)',
    },
    docs: [
    ...
    spotbot: [
      {
        ...
        a: 'Based on the AltSpot memo, you are subscribing for membership interests in ASC Aurora SPV, LLC — a special purpose vehicle formed by AltSpot to invest in Aurora Robotics’ Series A preferred stock. You own interests in the SPV, not shares of Aurora directly. Subject to AltSpot review, required documents, and final acceptance. Not legal, tax, or investment advice.',
      },
      {
        q: 'How is AltSpot paid on this deal?',
        a: 'Per the offering materials: a 5% platform fee and an admin reserve of up to 2%, both collected once at closing and itemized in your subscription documents — any unused admin reserve is returned to investors at close. AltSpot leads this deal and receives 20% carried interest on profits at exit. There are no annual fees and no capital calls, ever. Not legal, tax, or investment advice.',
      },
      {
        q: 'What are the biggest risks?',
        a: 'Based on the AltSpot memo: early-stage loss risk, customer concentration among 3PL operators, hardware supply-chain exposure, and long illiquidity — there is no established path to sell your position. AltSpot’s own $400,000 position carries these same risks. Please read the full Risk Factors document before subscribing.',
      },
    ],
    deck: [
      {
        kicker: 'Aurora Robotics · Series A',
        title: 'Warehouse automation the mid-market can actually buy.',
        body: [
          'Enterprise robotics starts at seven figures and eighteen-month integrations. Aurora ships a contained, per-lane picking system that installs in a weekend and pays back in under 14 months.',
        ],
        stats: [
      ...
      {
        kicker: 'Traction',
        title: 'Retention is doing the selling.',
        body: [
          'Revenue has compounded 3.1x year over year. The current order book extends into 2027, led by three national 3PL operators.',
        ],
        stats: [
          { k: 'YoY revenue growth', v: '3.1x' },
          { k: 'Expansion share of orders', v: '68%' },
          { k: 'Order book', v: 'into 2027' },
        ],
      },
      {
        kicker: 'The round',
        title: 'AltSpot led this round.',
        body: [
          'AltSpot underwrote the Series A through a full Oliphron diligence cycle — nine customer reference calls, a unit-economics rebuild from invoice data, and an independent technical review.',
          'Our warehouse committed the full check at close. We retain our position permanently and offer participation through ASC Aurora SPV at a $10,000 minimum.',
        ],
        stats: [
          { k: 'AltSpot committed', v: '$400K' },
          { k: 'SPV allocation', v: '$1.5M' },
          { k: 'Minimum', v: '$10K' },
        ],
      },
    ],
    ...
    spotbot: [
      {
        ...
        a: 'Based on the AltSpot memo, the Series B is led by a tier-1 healthcare investor; AltSpot holds an approved co-investment allocation on identical terms and conducted its own independent diligence. The lead’s identity is disclosed in the deal data room, available to approved members. Not legal, tax, or investment advice.',
      },
      {
        q: 'How is AltSpot paid on this deal?',
        a: 'Per the offering materials: a 5% platform fee and an admin reserve of up to 2%, collected once at closing and itemized in your documents — any unused admin reserve is returned to investors at close. As a standard co-investment, AltSpot receives 10% carried interest on profits at exit. No annual fees, no capital calls, ever. Not legal, tax, or investment advice.',
      },
      {
        q: 'When could I see liquidity?',
        a: 'Private positions are long-term and illiquid, and no exit timeline is promised. Distribution occurs only on a realization event such as an acquisition or public offering, subject to the SPV’s terms. Please treat capital committed here as untouchable for many years.',
      },
    ],
    deck: [
      {
        kicker: 'Meridian Health AI · Series B',
        title: 'The scribe every physician gets to keep.',
        body: [
          'Ambient clinical documentation deployed across 90+ hospital systems, cutting documentation time by 54% in published results.',
        ],
        stats: [
      ...
      },
      {
        ...
        stats: [
          ...
          { k: 'Expansion-led', v: 'Yes' },
        ],
      },
      {
        kicker: 'The round',
        title: 'Tier-1 led. Independently underwritten.',
        body: [
          'A tier-1 healthcare investor leads the Series B. AltSpot secured a co-investment allocation on identical terms — and underwrote the company independently before committing $250,000 of its own capital.',
        ],
        stats: [
          { k: 'AltSpot committed', v: '$250K' },
          { k: 'SPV allocation', v: '$2.0M' },
          { k: 'Minimum', v: '$10K' },
        ],
      },
    ],
  },
  {
    ...
    media: {
      ...
      series: [78, 100],
      caption:
        'AltSpot entry price indexed against last primary round (100). Source: transfer documentation, AltSpot memo.',
    },
    docs: [
    ...
    spotbot: [
      {
        ...
        a: 'Based on the AltSpot memo, the company approved this transfer under its right-of-first-refusal process, and AltSpot holds clean, documented title to the shares inside the SPV. Issuer approval matters because unapproved secondaries can be voided or blocked. Not legal, tax, or investment advice.',
      },
      {
        q: 'Why is there a discount?',
        a: 'Per the memo, the selling employee block was purchased at a 22% discount to the last primary round price, reflecting the illiquidity and size of the block. A discount at entry is not a guarantee of profit — the company’s value can change in either direction. Not legal, tax, or investment advice.',
      },
      {
        q: 'How is AltSpot paid on this deal?',
        a: 'Per the offering materials: a 5% platform fee and an admin reserve of up to 2%, collected once at closing and itemized — unused admin reserve is returned to investors at close — plus 10% carried interest on profits at exit. No annual fees, no capital calls, ever. Not legal, tax, or investment advice.',
      },
    ],
    deck: [
      {
        kicker: 'Summit Aerospace · Secondary',
        title: 'Institutional access, issuer-approved.',
        body: [
          'A documented, issuer-approved secondary interest in a late-stage launch-services company — acquired by AltSpot as principal and offered through a clean SPV at a $10,000 minimum.',
        ],
        stats: [
